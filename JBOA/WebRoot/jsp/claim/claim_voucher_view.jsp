...
<body>
<form action="ClaimViewAction" id="myForm" name="myForm" method="post" >
    	...
    	<div class="t">查看报销单</div>
   		<div class="pages">
        	<!--增加报销单 区域 开始-->
                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
                  ...
                  <tr>
                  	<td >编&nbsp;&nbsp;号：<s:property value="#claim.id"/></td>
                    <td>填&nbsp;写&nbsp;人：<s:property value=""/></td>
                    <td>部&nbsp;&nbsp;门：<s:property value=""/></td>
                    <td>职&nbsp;&nbsp;&nbsp;&nbsp;位：<s:property value=""/></td>
                  </tr>
                  <tr>
                    <td>总金额：<s:property value=""/></td>
                    <td>填报时间：<s:date name="" format="yyyy-MM-dd hh:mm:ss"/></td>
                    <td>状态：<s:property value=""/></td>
                    <td>待处理人：<s:property value=""/></td>
                  </tr>
                  <tr>
                  	<td colspan="4"><p>-------------------------------------------------------------------------------</p></td>
                  </tr>
          ...
          <p>&nbsp;</p>
               <%--  <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
                ...
                <s:iterator value="list" id="claimDetail" begin="0" status="s">
				<tr>
