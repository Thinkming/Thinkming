...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="action  divaction">
		...
		<div class="pages">
			<s:form action="../../../cn.action.AddClaimVoucherAction" name="claimForm">
			
			<input type="hidden" id="rowNumber" name="rowNumber" value="<s:property value="rowNumber"/>"/>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					<tr>
						<td>*填报人：</td>
						<td><s:property value="#session.sysemp.name"/></td>
						<td>*填报时间：</td>
						<td>2013-8-17 8：30</td>
					</tr>
					<tr>
						<td>*总金额：￥</td>
						<td><input type="text" id="totalAccount" name="claimVoucherdetail.bizClatmVoucher.totalAccount" value=""/></td>
						<td>*状态：</td>
						<td><input type="text" id="status" name="claimVoucherdetail.bizClatmVoucher.status" value="新创建"
