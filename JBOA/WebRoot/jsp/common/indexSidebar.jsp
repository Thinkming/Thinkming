...
<div class="nav" id="nav">
	<div class="t"></div>
   		<dl class="open">
	           ...
	           <dd><a href="SearchClaimVoucherAction">查看报销单</a></dd>
	           <s:if test='#session.sysemp.sysPosition.nameCn == "员工"'>
	           <dd><a href="AddClaimVoucherAction">添加报销单</a></dd>
	           </s:if>
	       </dl>
       <dl>
       ...
       <s:if test='#session.sysemp.sysPosition.nameCn == "部门经理"'>
       <dl>
       ...
       <s:if test='#session.sysemp.sysPosition.nameCn == "总经理" ||#session.employee_position == "财务"'>
       <dl>
       		<dt onclick="this.parentNode.className=this.parentNode.className=='open'?'':'open';">统计报表</dt>
